...
// If you want to delete some session data, just unset the corresponding key of 
// the $_SESSION associative array, as shown in the following example:

//destroy the session
session_destroy();

// Each PHP session has a timeout value (duration in seconds) that determines 
// how long the session should remain active without any user activity. 
// You can adjust this timeout by changing the value of the session.gc_maxlifetime variable 
